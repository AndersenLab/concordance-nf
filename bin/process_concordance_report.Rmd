...
gtcheck_old <- readr::read_tsv("~/Dropbox/AndersenLab/LabFolders/DanLu/4.concordance/20201010_CE/only_SNP_0.99938/gtcheck.tsv")

# new gt check from concordance-nf
gtcheck_new <- readr::read_tsv("gtcheck.tsv")

# sample coverage data - sample sheet for GATK
gatk_ss <- readr::read_tsv("~/Dropbox/AndersenLab/LabFolders/DanLu/3.GATK/20210105_all_CE/sample_sheet_GATK_20201230.tsv") 

# existing isotype data - output from concordance (download google sheet for correct species)
WI_sheet <- readr::read_tsv("C_elegans_WI_strain_info_20210115.tsv")
